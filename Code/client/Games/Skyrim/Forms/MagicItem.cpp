...
bool MagicItem::IsInvisibilitySpell() const noexcept
{
    ...
    // more general fix.
    //
    // What's broken here is load-order dependencies mean this patch is only "statistically correct."
    // Another .esl plugin with an 0x805 formID that is an invisibility spell might break.
    //
    if ((formID & 0xFF000FFF) == 0xfe000805)
        return false;
